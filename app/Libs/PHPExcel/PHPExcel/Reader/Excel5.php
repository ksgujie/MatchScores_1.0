...
//		echo '<br />';
	...
	private function _readWindow2()
	{
		...
		if ($this->_phpSheet->getSheetView()->getView() !== PHPExcel_Worksheet_SheetView::SHEETVIEW_PAGE_LAYOUT) {
			//NOTE: this setting is inferior to page layout view(Excel5-)
	...
	/**
	 * Read PLV Record(Created by Excel5 or upper)
	 */
	private function _readPageLayoutView(){
		...
		if ($fPageLayoutView === 1) {
			...
			$this->_phpSheet->getSheetView()->setZoomScale($wScalePLV); //set by Excel5 only if SHEETVIEW_PAGE_LAYOUT
		}
