...
class PHPExcel_Reader_Excel5 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
	...
	/**
	 * PHPExcel_Reader_Excel5_Theme instance
	 *
	 * @var PHPExcel_Reader_Excel5_Theme
	 */
			...
			switch ($rel["Type"]) {
				case "http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme":
					...
					if (is_object($xmlTheme)) {
						...
						self::$_theme = new PHPExcel_Reader_Excel5_Theme($themeName,$colourSchemeName,$themeColours);
					}
					break;
			}
		}
				...
				switch ($contentType["ContentType"]) {
					case "application/vnd.openxmlformats-officedocument.drawingml.chart+xml":
						if ($this->_includeCharts) {
							...
							$objChart = PHPExcel_Reader_Excel5_Chart::readChart($chartElements,basename($chartEntryRef,'.xml'));
