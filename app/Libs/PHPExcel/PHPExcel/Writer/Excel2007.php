...
class PHPExcel_Writer_Excel5 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
	 ...
	 *
	 * @var PHPExcel_Writer_Excel5_WriterPart[]
	 */
    ...
    public function __construct(PHPExcel $pPHPExcel = null)
    {
    	...
    	$writerPartsArray = array(	'stringtable'	=> 'PHPExcel_Writer_Excel5_StringTable',
									'contenttypes'	=> 'PHPExcel_Writer_Excel5_ContentTypes',
									'docprops' 		=> 'PHPExcel_Writer_Excel5_DocProps',
									'rels'			=> 'PHPExcel_Writer_Excel5_Rels',
									'theme' 		=> 'PHPExcel_Writer_Excel5_Theme',
									'style' 		=> 'PHPExcel_Writer_Excel5_Style',
									'workbook' 		=> 'PHPExcel_Writer_Excel5_Workbook',
									'worksheet' 	=> 'PHPExcel_Writer_Excel5_Worksheet',
									'drawing' 		=> 'PHPExcel_Writer_Excel5_Drawing',
									'comments' 		=> 'PHPExcel_Writer_Excel5_Comments',
									'chart'			=> 'PHPExcel_Writer_Excel5_Chart',
									'relsvba'		=> 'PHPExcel_Writer_Excel5_RelsVBA',
									'relsribbonobjects' => 'PHPExcel_Writer_Excel5_RelsRibbon'
								 );
	 ...
	 * @return 	PHPExcel_Writer_Excel5_WriterPart
	 */
